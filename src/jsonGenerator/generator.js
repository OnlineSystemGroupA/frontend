...
var generateApplication = function () {
    var applicationModelJson = {
        ...
        "expireHandle": "由本中心销毁",
        "expectedDate": '2023-07-20T16:00:00.000Z',
        "companyInfo": {
        ...
        "timeTables": [
            {
                ...
                "endTime": '2023-07-20T16:00:00.000Z',
            },
            {
                "task": '设计测试',
                "lastTime": '<@[2-10]>',
...
var generateTestReport = function () {
    var testReportModelJson = {
        ...
        "testType": '<@string{4,20}>',
        "reportDate": '2023-07-20T16:00:00.000Z',
        "projectId": '<@string{4,20}>',
        "sampleDate": '2023-07-20T16:00:00.000Z',
        "startDate": '2023-07-20T16:00:00.000Z',
        "endDate": '2023-07-20T16:00:00.000Z',
        ...
        "compileDate": '2023-07-20T16:00:00.000Z',
        "reviewer": '<@string{4,20}>',
        "reviewDate": '2023-07-20T16:00:00.000Z',
        "approver": '<@string{4,20}>',
        "approveDate": '2023-07-20T16:00:00.000Z',
...
var generateDocumentReviewForm = function () {
    var documentReviewModelJson = {
        ...
        reviewer: '<@string{4,20}>',
        finishDate: '2023-07-20T16:00:00.000Z',
        ...
        "problemList<@{3,6}>": [
            {
                ...
                discoveredDate: '2023-07-20T16:00:00.000Z',
...
var generateContractForm = function () {
    var contractModelJson = {
        ...
        signDate: '2023-07-20T16:00:00.000Z',
        validDate: '2023-07-20T16:00:00.000Z',
        ...
        clientInfo: {
            ...
            signatureDate: '2023-07-20T16:00:00.000Z',
            contact: '<@string{4,20}>',
            address: '<@string{4,20}>',
            telephone: '<@string{4,20}>',
            fax: '<@string{4,20}>',
