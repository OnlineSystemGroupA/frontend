<template>
    <div style="width: 80%">
        ...
        <el-table :data="itemList" border style="width: 100%; height: auto;">
            <el-table-column prop="id" label="项目号" style="width: 14%">
            ...
            <el-table-column prop="date" label="创建时间" style="width: 14%"> </el-table-column>
            <el-table-column prop="personInCharge" label="负责人" style="width: 14%"> </el-table-column>
            <el-table-column prop="client" label="申请人" style="width: 14%"> </el-table-column>
            <el-table-column prop="state" label="项目状态" style="width: 14%"> </el-table-column>
