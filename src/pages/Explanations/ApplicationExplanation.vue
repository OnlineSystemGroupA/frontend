<template>
    <div class="explanation">
        ...
        <ol>
            ...
            <li>《软件项目委托测试保密协议》、《软件项目委托测试合同》：格式按照合同及协议规范签订。
                <ol>① 书面各两分</ol>
                <ol>② 电子文档</ol>
            </li>
        ...
        <ol>
            <li>提交软件样品一套（与《委托测试软件功能列表》一致）；附相应的平台及支持性数据。</li>
        </ol>
        <h4 style="text-align: left">三、其它</h4>
        <ol>
            <li>以上一、二项所要求提交的电子文档集中刻成一张（或按实际情况分开来刻录）光盘里；</li>
    ...
    methods: {
        ...
        handleResult(res) {
            if (res.status === 200) {
                ...
                this.$bus.$emit('getId', res.data.processId)
            }
        },
        handleError(err) {
